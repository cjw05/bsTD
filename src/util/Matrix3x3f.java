			...
			{ this.m[0][0]*m1.m[0][0] //******
			 ...
			 this.m[0][0]*m1.m[0][1] //******
					 ...
					 this.m[0][0]*m1.m[0][2] //******
							 ...
							 +this.m[0][2]*m1.m[2][2]},
			{ this.m[1][0]*m1.m[0][0] //******
					 +this.m[1][1]*m1.m[1][0] //M[0,0]
					 +this.m[1][2]*m1.m[2][0],
					 this.m[1][0]*m1.m[0][1] //******
							 +this.m[1][1]*m1.m[1][1] //M[0,1]
							 +this.m[1][2]*m1.m[2][1],
							 this.m[1][0]*m1.m[0][2] //******
									 +this.m[1][1]*m1.m[1][2] //M[0,2]
									 +this.m[1][2]*m1.m[2][2]},
			{ this.m[2][0]*m1.m[0][0] //******
					 +this.m[2][1]*m1.m[1][0] //M[0,0]
					 +this.m[2][2]*m1.m[2][0],
					 this.m[2][0]*m1.m[0][1] //******
							 +this.m[2][1]*m1.m[1][1] //M[0,1]
							 +this.m[2][2]*m1.m[2][1],
							 this.m[2][0]*m1.m[0][2] //******
									 +this.m[2][1]*m1.m[1][2] //M[0,2]
									 +this.m[2][2]*m1.m[2][2]}
